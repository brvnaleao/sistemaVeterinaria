    ...
    <div class="container">
      <div class="columns has-background-light is-multiline">
        <div class="column center">
          <div class="notification back" id="area2">
           
                <form method="POST" action="conexao.php" id="formulario2" autocomplete="off">
                  <fieldset>
                    <label>Nome do dono:</label><input class="campo_nome" name="nomepessoa" type="text"><br><br>
                    
                    <label>Email:</label><input class="campo_email" name="emailmsg" type="email"><br><br>
                    
                    <label>Deixe sua mensagem:</label><textarea class="mensagens" name="mensagem" maxlength="100" cols="5"></textarea> <br><br>

                    <input class="button is-info botao" type="submit" name="save2" value="Enviar">
                  </fieldset>
                </form>
